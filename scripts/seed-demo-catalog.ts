...
const IMG = {
  engine: [
    "https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?w=800&h=800&fit=crop&auto=format",
    "https://images.unsplash.com/photo-1486006920555-c77dcf18193c?w=800&h=800&fit=crop&auto=format",
    "https://images.unsplash.com/photo-1632823469850-1b7b6e85d4a6?w=800&h=800&fit=crop&auto=format",
    "https://images.unsplash.com/photo-1581092335397-9fa73d2d7b6f?w=800&h=800&fit=crop&auto=format",
    "https://images.unsplash.com/photo-1635774855536-9728f2610245?w=800&h=800&fit=crop&auto=format",
  ],
  tire: [
    "https://images.unsplash.com/photo-1486006920555-c77dcf18193c?w=800&h=800&fit=crop&auto=format",
    "https://images.unsplash.com/photo-1626668893632-6f3a4466d109?w=800&h=800&fit=crop&auto=format",
    "https://images.unsplash.com/photo-1605164599901-db7f68c4b3a3?w=800&h=800&fit=crop&auto=format",
  ],
  headlight: [
    "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=800&h=800&fit=crop&auto=format",
    "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=800&h=800&fit=crop&auto=format",
  ],
  brake: [
    "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=800&h=800&fit=crop&auto=format",
    "https://images.unsplash.com/photo-1486754735734-325b5831c3ad?w=800&h=800&fit=crop&auto=format",
  ],
  body: [
    "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=800&h=800&fit=crop&auto=format",
    "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800&h=800&fit=crop&auto=format",
  ],
  tools: [
    "https://images.unsplash.com/photo-1530124566582-a618bc2615dc?w=800&h=800&fit=crop&auto=format",
    "https://images.unsplash.com/photo-1591805985000-0bc4d2d4b6a6?w=800&h=800&fit=crop&auto=format",
  ],
  electronics: [
    "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=800&h=800&fit=crop&auto=format",
...
function makeProduct(args: {
  ...
  // 1-3 images per product, mixing themed pool + picsum for variety
  ...
  for (let i = 0; i < imgCount; i++) {
    const url =
      i === 0
        ? pick(args.imagePool)
        : picsumImage(args.picsumSeed + "-" + i);
    images.push({ url, displayOrder: i });
  }
